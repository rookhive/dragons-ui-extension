DragonsUIObserver.register('adventureTimerFix', class extends DragonsUIObserver.Feature {
    init() {
        if (
            ...
            // Пожалуйста, напишите <a class="blue" href="https://www.mist-game.ru/user_270906.html" target="_blank">cwaffie</a> для скорейшего исправления проблемы.
            return
        }
